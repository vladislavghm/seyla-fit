...
if [ -d "public/admin" ]; then
    ...
    echo -e "${YELLOW}   scp -r public/admin vladhoyl@ekbszsndmc:~/seyla-fit/public/${NC}"
    echo -e "${YELLOW}   ${NC}"
    echo -e "${YELLOW}   # Вариант 2: Через rsync${NC}"
    echo -e "${YELLOW}   rsync -avz public/admin/ vladhoyl@ekbszsndmc:~/seyla-fit/public/admin/${NC}"
    echo -e "${YELLOW}   ${NC}"
